...
#include <fstream>			// procesador de archivos de texto
#include <string>			// cadenas de caracteres
#include <sstream>			// flujos de cadenas de caracteres
#include <vector>			// vectores
#include <list>				// listas implementación de C++
#include <map>				// mapas, similares a arboles binarios vistos en clase
#include <iterator>			// recorrer elementos en las listas o mapas

#include "Digrafo.h"		// Directed Graph || o Grafo Dirigido
#include "RutaBFS.h"		// Algoritmo de busqueda en anchura BFS

using std::ifstream;		// procesar archivos de texto
using std::string;			// cadenas de caracteres
using std::cout;			// salida en pantalla
using std::cin;				// entrada de teclado
using std::stoi;			// convertir cadenas en enteros
using std::endl;			// fin de linea
using std::istringstream;	// flujo de caracteres de entrada
using std::vector;			// vectores
using std::map;				// mapas
using std::pair;			// pareces clave-valor de un mapa
