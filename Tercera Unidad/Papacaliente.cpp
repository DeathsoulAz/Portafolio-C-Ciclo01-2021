...
int main(){
	vector<string> jugadores = {"1.Erick", "2.Enmanuel", "3.Briam", "4.Gabriel", "5.Maria", "6.Oscar", "7.Krista",
...
void papaCaliente(const vector<string> &listaNombres){
	...
	for(int i = cantidadJugadores; i > 1; i--){
		...
		string perdedor = simulacion.dequeue();
		cout << perdedor << endl;
		cout << "Alto!!" << perdedor << " sale del juego..." << endl << endl;	
	}
